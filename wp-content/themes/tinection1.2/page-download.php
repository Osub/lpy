	...
	<div id="single-blog-wrap" class="container two-col-container">
		...
		<div class="downmid">
			<div class="downld">
				...
				<div class="downldlinks single-download">
					...
					<div class="down-mail">
						...
						<div class="dl-terms">
							<p class="dl-msg"></p>
							<input type="checkbox" name="dl-terms" id="dl-terms-chk" /><?php _e('我同意','tinection'); ?>&nbsp;<a href="<?php bloginfo('home'); echo'/copyright'; ?>" title="" target="_blank"><?php _e('本站条款','tinection'); ?></a><?php _e('并愿意接收包含最新文章的订阅邮件。','tinection'); ?>
		...
		<div class="downtop">
			<div class="dl-article-title">
				...
				<a href="<?php bloginfo('home'); ?>" title="<?php bloginfo('name'); ?>" target="_blank"><?php echo sprintf(__('去%1$s看看最新文章或者尝试搜索功能','tinection'),get_bloginfo('name')); ?></a>
			</div>
			<div class="declaration">
			<p><?php _e('本站所刊载内容均为网络上收集整理，包括但不限于代码、应用程序、影音资源、电子书籍资料等，并且以研究交流为目的，所有仅供大家参考、学习，不存在任何商业目的与商业用途。若您使用开源的软件代码，请遵守相应的开源许可规范和精神，若您需要使用非免费的软件或服务，您应当购买正版授权并合法使用。如果你下载此文件，表示您同意只将此文件用于参考、学习使用而非任何其他用途。','tinection'); ?>
			</p>
...
<?php }?>
<div class="buy-pop-out">
	<div class="buy-pop-title"><h4><?php _e('资源购买','tinection'); ?></h4></div>
	<div class="buy-des">
	...
	<p class="confirm-buy"><button class="cancel-to-back btn btn-warning"><?php _e('取消','tinection'); ?></button></p>
	<span class="buy-close"><i class="fa fa-close"></i></span>
</div>
<?php get_footer(); ?>