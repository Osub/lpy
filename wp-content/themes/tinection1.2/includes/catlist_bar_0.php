...
?>
<?php if($i<2){ ?>
<span class="col-up catlist-style">
<article class="home-blog-entry clr">
	...
	<p>
		<?php $contents = get_the_excerpt(); $excerpt = wp_trim_words($contents,75,ot_get_option('readmore')); echo $excerpt;?>
	</p>
	</div>
</article>
</span>
<?php }else{ ?>
<span class="col-down catlist-style">
