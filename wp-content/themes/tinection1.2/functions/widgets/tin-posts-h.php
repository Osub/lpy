			...
			<div class="post-item-thumbnail">
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
					<?php if ( has_post_thumbnail() ): ?>
						<img src="<?php $imgsrc = $large_image_url[0]; echo tin_thumb_source($imgsrc,188,140,false); ?>" alt="<?php the_title(); ?>" />
						<span><?php the_article_icon();?></span>
					<?php else: ?>
						<img src="<?php $imgsrc = catch_first_image(); echo tin_thumb_source($imgsrc,188,140,false); ?>" alt="<?php the_title(); ?>" />
						<span><?php the_article_icon();?></span>
					<?php endif; ?>
				</a>
			</div>
