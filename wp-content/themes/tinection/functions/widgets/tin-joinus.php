...
/* ------------------------------------ */
	...
	?>
		...
		<div class="joinus">如果您有不错的资源想发布至本站，您可以<a href="http://www.zhiyanblog.com/author/contribute?tab=post&action=new" target="_blank" title="投稿">点击投稿</a>。我们强烈推荐您注册本站账户或通过QQ、新浪微博登陆本站，使用投稿功能，畅想丰富资源以及积分服务。</div>
		<h3><span>站务合作</span></h3>
		<div class="sitecooperate">如果您有站务合作方面的需求，请通过以下方式联系我。<br>QQ: 813920477<br>Email: chinash2010#gmail.com(#换成@)</div>
