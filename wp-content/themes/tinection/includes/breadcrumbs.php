...
<?php elseif ( is_search() ): ?>
	...
	<div class="breadcrumbs-text">
		<?php $search_count = 0; if(!empty($_GET['s'])):$search = new WP_Query("s=$s & showposts=-1"); if($search->have_posts()) : while($search->have_posts()) : $search->the_post(); $search_count++; endwhile; endif; endif; echo $search_count;?><?php _e(' 个搜索结果...','tinection'); ?>
	</div>
<?php elseif ( is_404() ): ?>
...
<?php elseif ( is_author() ): ?>
	...
	<div id="breadcrumbs"><h1><i class="fa fa-user"></i><?php _e(' 个人资料','tinection'); ?></h1>
