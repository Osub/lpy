...
?>
				...
				<div class="relatedposts-inner">
					...
					<?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large');?><?php if ( has_post_thumbnail() ) { ?>
						<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="">
							<div class="thumb-img">
								<img src="<?php $imgsrc = $large_image_url[0]; echo tin_thumb_source($imgsrc,175,126,false); ?>" alt="<?php the_title(); ?>">
					...
					<?php if ( !has_post_thumbnail() ) {  ?>	
						<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" class="">
							<div class="thumb-img">
								<img src="<?php $imgsrc = catch_first_image(); echo tin_thumb_source($imgsrc,175,126,false); ?>">
								<span><?php the_article_icon();?></span>
							</div>
						</a>
						<?php }?>
		...
		<ul>
		<?php query_posts(array('orderby'=>'rand','showposts'=>4,'caller_get_posts'=>1));
		if (have_posts()) :
