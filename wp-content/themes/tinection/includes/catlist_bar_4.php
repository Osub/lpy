...
?>
<?php if($i==1){ ?>
<span class="col-left catlist-style4">
...
<?php }else{ ?>
<?php if($i==2){echo '<span class="col-right catlist-style4">';} ?>
<article class="clr col-small">
	<h3><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h3>
	<p>
		<?php $contents = get_the_content(); $excerpt = wp_trim_words($contents,ot_get_option('excerpt-length'),ot_get_option('readmore')); echo $excerpt;?>
	</p>
