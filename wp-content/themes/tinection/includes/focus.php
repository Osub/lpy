...
<div id="focus-slide" class="ie_pie">
	...
	<p class="focus-content" style="line-height: 20px;margin-bottom: 10px;">
		...
		<!-- 可删除 -->
		<a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=9dcf8d2c615e22fe02da09ab4ea5e0fac7c0dd5c75dce415e7781e89874e3546"><i class="fa fa-users">&nbsp;&nbsp;</i>加入QQ群</a>
		<!-- 删除截止 -->
	</p>
	...
	<form action="http://list.qq.com/cgi-bin/qf_compose_send" target="_blank" method="post">
		...
		<input type="email" name="focus-email" class="focus-email" placeholder="<?php _e('输入邮箱,订阅本站','tinection'); ?>" required />
