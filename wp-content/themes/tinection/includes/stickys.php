...
?>
<!-- Stickys -->
<?php $stickys = get_option('sticky_posts');$stickys_num = count($stickys);$args = array('posts_per_page' => 4,'post__in' => $stickys); if($stickys_num!=0): $stickys_query = new wp_query( $args );?>
...
<?php while ($stickys_query -> have_posts()) : $stickys_query -> the_post(); ?>	
